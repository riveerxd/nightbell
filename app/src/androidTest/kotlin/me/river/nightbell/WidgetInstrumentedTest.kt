...
class WidgetInstrumentedTest {
    ...
    private fun columns(root: View): List<View> = buildList {
        val container = root.findViewById<android.view.ViewGroup>(me.river.nightbell.R.id.widget_columns)
    ...
    fun theSettingsCogSurvivesHidingTheTitle() {
        ...
        val cog = root.findViewById<View>(me.river.nightbell.R.id.widget_settings)
        assertNotNull(cog)
