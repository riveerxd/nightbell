 ...
 * questions chosen are the ones the design actively invites: Pulse deliberately
...
private val topics = listOf(
    HelpTopic(
        ...
        "Android's scheduler has a hard fifteen-minute floor for periodic background " +
            "work, and it silently clamps anything shorter. Pulse clamps it visibly " +
    ...
    HelpTopic(
        ...
        "Because the slowness may have been yours. Pulse times a known-good endpoint " +
    ...
    HelpTopic(
        ...
        "Every HTTPS check completes a handshake, and the handshake carries the " +
            "certificate's expiry date, so watching it is free. Pulse says something " +
    ...
    HelpTopic(
        ...
        "Element checks load the page in an offscreen browser and wait a few seconds " +
            ...
            "blocks headless browsers, can genuinely render for you and not for Pulse. " +
...
fun HelpCard() {
    ...
    GlassCard {
        SectionHeader("Help", icon = PulseIcons.Info, accent = PulseColors.Sky)
        Text(
            ...
            Column {
                Row(
                    ...
                    Text(
                        ...
                        color = if (open) PulseColors.TextPrimary else PulseColors.TextSecondary,
